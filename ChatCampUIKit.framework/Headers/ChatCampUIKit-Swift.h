...
@interface GroupChannelsViewController : UITableViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC13ChatCampUIKit29OpenChannelChatViewController")
@interface OpenChannelChatViewController : MessagesViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
...
@interface OpenChannelChatViewController (SWIFT_EXTENSION(ChatCampUIKit)) <UIDocumentInteractionControllerDelegate>
@end


@interface OpenChannelChatViewController (SWIFT_EXTENSION(ChatCampUIKit)) <AVAudioRecorderDelegate>
@end
...
@interface OpenChannelChatViewController (SWIFT_EXTENSION(ChatCampUIKit)) <UIDocumentMenuDelegate, UIDocumentPickerDelegate>
- (void)documentMenu:(UIDocumentMenuViewController * _Nonnull)documentMenu didPickDocumentPicker:(UIDocumentPickerViewController * _Nonnull)documentPicker;
@end
...
@interface OpenChannelsViewController : UITableViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithStyle:(UITableViewStyle)style OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface UsersViewController (SWIFT_EXTENSION(ChatCampUIKit)) <UISearchResultsUpdating>
